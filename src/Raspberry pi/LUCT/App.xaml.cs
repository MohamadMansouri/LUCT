...
namespace LUCT
{
    ...
    sealed partial class App : Application
    {
        ...
        /// </summary>
        /// 
        public static AppDbContext LUCTDatabase = new AppDbContext();
        public static GPIOService LUCTGPIOService = new GPIOService();
        public int switch1 = 0, switch2 = 0;
        public App()
        {
        ...
        public static ImageBrush BackgroundImage { get; set; } = new ImageBrush()
            {
                ImageSource = new Windows.UI.Xaml.Media.Imaging.BitmapImage(new Uri("ms-appx:///Assets/Background.png"))
            };
