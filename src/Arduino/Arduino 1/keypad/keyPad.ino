...
LiquidCrystal lcd(A3, A2, A1, A0, 1, 0);
...
*/
  ...
  { 
    ...
    Password_Lenght=Wire.read()+1;

    for(int i=0;i<Password_Lenght-1;i++)
    {
...
/*
Serial.println(banQouta);
Serial.println(banTime);
Serial.println(Password_Lenght);
